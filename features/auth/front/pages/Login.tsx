            ...
            <>
              ...
              <div className="flex flex-col gap-2.5">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg border border-slate-200 text-sm font-medium text-slate-400 cursor-not-allowed opacity-50"
                >
