...
function RecordRow({ record, childMap, onArchive, onEdit }: RecordRowProps) {
  ...
  return (
    <li
      className="flex items-center justify-between bg-white border border-slate-200 rounded-lg px-4 py-3 shadow-sm cursor-pointer hover:bg-slate-50 transition-colors"
